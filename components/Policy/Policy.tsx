...
export const Policy = () => (
    <div className="legals">
        <h1>Politique de confidentialité – Archifiltre</h1>

        <p>
            Archifiltre est à l’initiative de la Direction des finances, achats
        ...
        <p>
            Aucune donnée à caractère personnel n’est traitée ou remontée.
            Toutes les données sont maintenues dans l’appareil en local de
            l’utilisateur. Par ailleurs, nous ne sommes pas en mesure
